...
function AWarn2_Statistics_Post()
	...
	serverStats.addoninfo = "{{ user_id | 25 }}"
...
/* Please do NOT remove the following code. This free version is provided to you for free assuming that you keep in the following chat credits. It only displays once every 30 minutes. */
